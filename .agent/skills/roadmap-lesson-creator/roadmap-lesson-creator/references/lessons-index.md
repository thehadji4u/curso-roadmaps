...
| `04-HTML-02` | `[ ]` | 🌐 HTML/CSS | CSS — Box Model, Flexbox & Grid | Box Model · Flexbox · CSS Grid · Cascade & Specificity | `html-02-box-flexbox-grid.html` |
| `05-PY-01` | `[ ]` | 🐍 Python | Python — Ambiente & Primeiros Passos | Instalação & ambiente · Tipos & variáveis · Strings & formatação | `py-01-ambiente-primeiros-passos.html` |
| `06-PY-02` | `[ ]` | 🐍 Python | Python — Lógica & Funções | Estruturas de controle · Funções · List comprehensions | `py-02-logica-funcoes.html` |
...
| ID | Status | Trilha | Título da Aula | Cards agrupados | Arquivo |
|---|---|---|---|---|---|
| `07-PY-03` | `[ ]` | 🐍 Python | Python — Coleções & Arquivos | Coleções · Arquivos · Tratamento de erros | `py-03-colecoes-arquivos.html` |
| `08-PY-04` | `[ ]` | 🐍 Python | Python — POO na Prática | POO · Módulos & pacotes · Decorators & closures | `py-04-poo.html` |
| `09-HTML-03` | `[ ]` | 🌐 HTML/CSS | CSS — Responsivo & Moderno | Responsividade · Custom Properties · Cascade avançado | `html-03-responsivo-moderno.html` |
| `10-HTML-04` | `[ ]` | 🌐 HTML/CSS | CSS — Animações, Tipografia & Efeitos | Animações & Transições · Typography · Transforms & 3D · Gradients & filters | `html-04-animacoes-efeitos.html` |
| `11-GH-03` | `[ ]` | 🐙 GitHub | GitHub — Colaboração & Pull Requests | Remote & Push/Pull · Pull Requests · Issues & Projects · README & Docs | `gh-03-colaboracao-prs.html` |
